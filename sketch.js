...
function draw() {
  ...
  if(gameState === PLAY){
   ...
   /*backGround.depth = obstaclesGroup.depth;
    backGround.depth = trex.depth;*/
    obstaclesGroup.depth = obstaclesGroup.depth+2; 
  ...
  if(mousePressedOver(restart)||(keyDown("space")&&gameState===END)||keyDown(UP_ARROW)&&gameState===END) {
      reset();
    }
